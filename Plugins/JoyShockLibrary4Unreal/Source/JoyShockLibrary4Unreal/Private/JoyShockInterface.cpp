...
void FJoyShockInterface::ProcessIMUState(const FIMUState& InIMUState, const FIMUState& InPreviousIMUState,
	FPlatformUserId PlatformUser, FInputDeviceId InputDevice) const
{
	OnControllerAnalog(PlatformUser, InputDevice, AccelerationXName, InIMUState.accelX, InPreviousIMUState.accelX, 0);
	OnControllerAnalog(PlatformUser, InputDevice, AccelerationYName, InIMUState.accelY, InPreviousIMUState.accelY, 0);
	OnControllerAnalog(PlatformUser, InputDevice, AccelerationZName, InIMUState.accelZ, InPreviousIMUState.accelZ, 0);
	
	FVector Orientation = UJoyShockLibrary::JSL4UGetMotionState(PlatformUser).Orientation.Rotator().Euler();
	OnControllerAnalog(PlatformUser, InputDevice, RotationXName, Orientation.X, 0, 0);
	OnControllerAnalog(PlatformUser, InputDevice, RotationYName, Orientation.Y, 0, 0);
	OnControllerAnalog(PlatformUser, InputDevice, RotationZName, Orientation.Z, 0, 0);
}
